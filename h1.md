...
Kirjoitin komentoriville "sudo apt-get update" hakeakseni viimeisimmät päivitykset ja sen jälkeen "sudo apt-get -y dist upgrade" päivittääkseni kaiken. Kaiken päivitys vei aikaa yllättävän paljon, melkein tunnin.  ![firewall](https://github.com/user-attachments/assets/7fd8b6fb-fff3-4928-a83a-74fac5f0db5a)  
 ...
 Lopuksi täytyi vielä ratkaista skaalautuvuusongelma. Ongelman saa korjauttua asentamalla Virtual Box Guest Additionsin. Menin Virtualboxissa "Devices" menuun, josta valittiin alimmainen vaihtoehto "Insert Guest Additions CD image...". Sen jälkeen syötin terminalissa seuraavat komennot:  ![vbox](https://github.com/user-attachments/assets/7e8336f1-6766-4da1-afd8-f1dae936c327)
 

 Terminal ilmoitti virheilmoituksia, ja kone täytyi käynnistää uudestaan (applications - log out - restart). Käynnistyksen jälkeen skaalautuvuusongelma oli ratkennut - virtuaalikoneen työpöytää pystyi suurentamaan ikkunaa venyttämällä, kuten olemma tottuneet.
