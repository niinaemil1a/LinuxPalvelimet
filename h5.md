...
![conf5](https://github.com/user-attachments/assets/93e95acc-2872-42a1-9bc4-e404da918efa)  

Muutoksien jälkeen `sudo a2ensite niinamatela.me.conf` `sudo systemctl restart apache2` jotta muutokset tulevat voimaan:  
  
![vnamebh](https://github.com/user-attachments/assets/0eb448cf-2d5b-40ee-b92c-914ec93f4c42)  

Nyt sivut niinamatela.me/blogi, niinamatela.me/yhteystiedot ja niinamatela.me/esittely toimivat. Lopuksi vielä muokkasin sivuja ilman pääkäyttäjäoikeuksia 
