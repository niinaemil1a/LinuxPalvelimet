...
Tässä Linux pohjaisessa käyttöjärjestelmässä komentorivi löytyy  vasemmasta yläkulmasta `applications` - `terminal emulator`. Komentorivi on käyttöjärjestelmän ja tietokoneohjelmien käyttöliittymä (Jyväskylän yliopisto - Komentorivi).
