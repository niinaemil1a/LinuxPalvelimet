...
Tein harjoitukset 30.8.24-31.8.24 Koneena oli HP laptop R5 8GB RAM 512GB SSD, Windows 11 käyttöjärjestelmällä.
...
Ncdu:ssa liikuttiin nuolinäppäimillä, komennolla `i` nähdään lisätietoja ja komennolla `d` voidaan poistaa turhia tiedostoja. Help löytyy komennolla `shift + ?`  
