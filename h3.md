...
Pienen googlaamisen (https://linuxize.com/post/how-to-edit-your-hosts-file/) jälkeen tajusin, että en ollut tehnyt tarvittavia muutoksia etc/hosts/ tiedostoon joten kävin muokkaamassa sitä:   
