...
Googlaamisen jälkeen tajusin, että en ollut tehnyt tarvittavia muutoksia etc/hosts/ tiedostoon joten kävin muokkaamassa sitä:   
...
Nyt hattu.example.com vie haluamalline sivulle, mutta vieläkään localhost ei vie sinne. Googlaan ohjeita, ja selviää, että en ole lisännyt tiedostoon localhostin tietoja, joten lisään ne:  
