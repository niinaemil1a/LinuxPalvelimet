...
Sen jälkeen kokeilin localhostia selaimessa, sekä terminalissa `curl localhost`. Tuloksena tuli html:lää:  
...
Seuraavaksi testasin, miten serveri löytyy netistä. `ip addr`  
...
joka avasi firefoxissa Apache2 Debian Default Pagen.  
