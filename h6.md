...
`micro harjoitus1/settings.py` lisätään ohjelma installed_apps kohtaan:  
    INSTALLED_APPS = [
...
`micro crm/models.py` tiedostoon lisättiin tietokantataulu:  

`./manage.py makemigrations`  
`./manage.py migrate`  
`micro crm/admin.py` jolla taulu rekisteröidään adminille  
